...
| Node palette (58 shapes, 9 groups) | M-3 | manual (palette drag-to-canvas) | PASS |
...
| Examples menu | M-17 | manual (DMZ Demo + Process Flow) | PASS |
...
| AC-2 JSON round-trip | AC-2 | audit.mjs#json-round-trip | PASS |
| AC-3 PUML round-trip | AC-3 | audit.mjs#puml-round-trip + empty input | PASS |
| AC-4 fixture tests | AC-4 | run-tests.js (15/15) | PASS |
| AC-5 zero network + console | AC-5 | audit.mjs#zero-network | PASS |
| AC-6 GIF validity | AC-6 | audit.mjs#gif-signature | PASS |